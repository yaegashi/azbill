...
func (client ReservationsSummariesClient) List(ctx context.Context, scope string, grain Datagrain, startDate string, endDate string, filter string) (result ReservationSummariesListResultPage, err error) {
	...
	req, err := client.ListPreparer(ctx, scope, grain, startDate, endDate, filter)
	if err != nil {
...
func (client ReservationsSummariesClient) ListPreparer(ctx context.Context, scope string, grain Datagrain, startDate string, endDate string, filter string) (*http.Request, error) {
...
func (client ReservationsSummariesClient) ListComplete(ctx context.Context, scope string, grain Datagrain, startDate string, endDate string, filter string) (result ReservationSummariesListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ReservationsSummariesClient.List")
		defer func() {
			sc := -1
	...
	result.page, err = client.List(ctx, scope, grain, startDate, endDate, filter)
	return
}
