...
func (client ReservationsDetailsClient) List(ctx context.Context, scope string, startDate string, endDate string, filter string) (result ReservationDetailsListResultPage, err error) {
	...
	req, err := client.ListPreparer(ctx, scope, startDate, endDate, filter)
	if err != nil {
...
func (client ReservationsDetailsClient) ListPreparer(ctx context.Context, scope string, startDate string, endDate string, filter string) (*http.Request, error) {
...
func (client ReservationsDetailsClient) ListComplete(ctx context.Context, scope string, startDate string, endDate string, filter string) (result ReservationDetailsListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ReservationsDetailsClient.List")
		defer func() {
			sc := -1
	...
	result.page, err = client.List(ctx, scope, startDate, endDate, filter)
	return
}
